...
} from '@core/services/interfaces/source.interface';
...
import { decodeVLQ, encode, encodeArrayVLQ } from '@components/base64.component';
...
export class SourceService {
     ...
     *
     * @returns A base64 encoded string representing the source map.
     */

    toString(): string {
        return encode(JSON.stringify(this.getMapObject()));
    }
